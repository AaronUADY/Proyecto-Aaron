...
2- compile el archivo: ADA04_E02.c
	Esto le creara el archivo ADA04_E02.exe

3- Ejecute ADA04_E02.exe (puede compilar y correr desde Visual Studio Code
a la vez.)
...
NOTA: para toda búsqueda por titulo, siempre que usted use un fragmento de el titulo, el programa le podrá regresar un titulo que contenga ese fragmento, usualmente el primero de la lista que cumpla ese fragmento.
